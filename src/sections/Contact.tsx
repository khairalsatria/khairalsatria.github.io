        ...
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          >
            ...
            <p style={{
              ...
              Your feedback helps improve this portfolio website and its user experience.
            </p>
          ...
          >
            ...
            {submitted ? (
              <div style={{
                ...
                <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '24px' }}>
                  Message sent!
                </h3>
                <p style={{ fontFamily: 'var(--font-display)', color: 'var(--black)', marginTop: '8px' }}>
