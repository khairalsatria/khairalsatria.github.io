...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      {/* ── Layer 1: Aurora gradient mesh (slowest) ── */}
      <div style={{
      ...
      <div style={{
        ...
        backgroundImage: `repeating-linear-gradient(
          ...
          transparent,
          transparent 80px,
          rgba(197,244,0,0.07) 80px,
          rgba(197,244,0,0.07) 81px
        )`,
        animation: 'diagonalSlide 18s linear infinite',
      }} />

      {/* ── Layer 4: Floating blobs ── */}
      <div style={{
      ...
      <div style={{
        ...
        <div style={{ width: '40px', height: '0px', background: 'var(--black)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px' }}>⚡</div>
        <div>
